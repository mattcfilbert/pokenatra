...
Pokemon.destroy_all
Trainer.destroy_all
Trainer.create(name: "Gizmo", level: rand(100), img_url: "https://img.pokemondb.net/artwork/charmander.jpg")
Trainer.create(name: "Fidget", level: rand(100), img_url: "https://img.pokemondb.net/artwork/squirtle.jpg")
